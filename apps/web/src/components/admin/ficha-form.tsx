...
export function FichaForm() {
  ...
  const onSubmit = async (_data: FichaFormData) => {
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="space-y-4">
                <div>
                  <h4 className="font-medium mb-2 text-foreground">Lugar de Nacimiento *</h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="lugarNacimientoMunicipio">Municipio</Label>
                      <Input
                ...
                <div>
                  <h4 className="font-medium mb-2 text-foreground">Lugar de Fallecimiento (opcional)</h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="lugarFallecimientoMunicipio">Municipio</Label>
              ...
              <div className="space-y-4 mt-6">
                <div className="space-y-2">
                  <Label htmlFor="actividadRelevante">Actividad Relevante</Label>
                  <Textarea
                ...
                <div className="space-y-2">
                  <Label htmlFor="familiaresDestacados">Familiares Destacados</Label>
                  <Textarea
                ...
                <div className="space-y-2">
                  <Label htmlFor="tematicaPrincipal">Temática Principal de su Obra</Label>
                  <Textarea
                ...
                <div className="space-y-2">
                  <Label htmlFor="generoPrincipal">Género Principal Cultivado</Label>
                  <Input
                ...
                <div className="space-y-2">
                  <Label htmlFor="contextoHistorico">Contexto Histórico en que Vivió</Label>
                  <Textarea
            ...
            <CardContent className="pt-6">
              <div className="space-y-6">
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">Formato .jpg recomendado</p>
                </div>

                <div className="space-y-2">
                  <Label htmlFor="archivoAudio">Audio con la Voz del Autor</Label>
                  <div className="flex items-center gap-4">
                    <Input
                  ...
                  <p className="text-sm text-muted-foreground">Formato .mp3 recomendado</p>
                </div>
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    {errors.editorId && (
                      <p className="text-sm text-red-500">{errors.editorId.message}</p>
                    )}
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    {errors.revisorId && (
                      <p className="text-sm text-red-500">{errors.revisorId.message}</p>
                    )}
                  </div>
                </div>

                <div className="bg-muted p-4 rounded-lg">
                  <h4 className="font-medium mb-2 text-foreground">Instrucciones para el Editor</h4>
