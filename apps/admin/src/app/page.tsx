            ...
            <div className="mt-8">
              {activeTab === "fichas" && (
                <Card className="border-border/50 shadow-sm">
                  <CardHeader>
                    <CardTitle>Gestión de Fichas Literarias</CardTitle>
                    <CardDescription>
                        ...
                        <CardContent>
                          <div className="space-y-4">
                            <div className="flex justify-between items-center p-3 rounded-md hover:bg-secondary/50 transition-colors">
                              ...
                              <span className="font-semibold bg-secondary px-2.5 py-0.5 rounded-full text-sm">12</span>
                            </div>
                            <div className="flex justify-between items-center p-3 rounded-md hover:bg-secondary/50 transition-colors">
                              <span className="text-sm font-medium">Por Revisar</span>
                              <span className="font-semibold bg-secondary px-2.5 py-0.5 rounded-full text-sm">8</span>
                            </div>
                            <div className="flex justify-between items-center p-3 rounded-md hover:bg-secondary/50 transition-colors">
                        ...
                        <CardContent>
                          <div className="space-y-4 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-border before:to-transparent">
                            <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                              <div className="flex items-center justify-center w-10 h-10 rounded-full border border-white bg-slate-100 dark:bg-slate-800 dark:border-slate-900 group-[.is-active]:bg-primary group-[.is-active]:text-primary-foreground text-slate-500 shadow shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 z-10 transition-colors">
                                <span className="text-xs font-bold">1</span>
                              </div>
                              <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-card border border-border/50 p-4 rounded shadow-sm hover:shadow-md transition-shadow">
                                <div className="flex items-center justify-between space-x-2 mb-1">
                                  <div className="font-bold text-sm">Ficha "Andrés Bello" completada</div>
                            ...
                            <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
                              <div className="flex items-center justify-center w-10 h-10 rounded-full border border-white bg-slate-100 dark:bg-slate-800 dark:border-slate-900 text-slate-500 shadow shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 z-10 transition-colors">
                                <span className="text-xs font-bold">2</span>
                              </div>
                              <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-card border border-border/50 p-4 rounded shadow-sm hover:shadow-md transition-shadow">
                                <div className="flex items-center justify-between space-x-2 mb-1">
                                  <div className="font-bold text-sm">Usuario nuevo registrado</div>
                            ...
                            <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
                              ...
                              <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-card border border-border/50 p-4 rounded shadow-sm hover:shadow-md transition-shadow">
                                <div className="flex items-center justify-between space-x-2 mb-1">
                                  <div className="font-bold text-sm">3 fichas validadas</div>
              ...
              {activeTab === "nueva" && (
                <Card className="border-border/50 shadow-sm">
                  <CardHeader>
                    <CardTitle>Crear Nueva Ficha Literaria</CardTitle>
                    <CardDescription>
                      Agrega una nueva ficha al sistema y asigna editores y
                      revisores
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
