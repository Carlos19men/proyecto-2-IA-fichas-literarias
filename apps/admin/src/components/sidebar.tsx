...
export function Sidebar({ activeTab, setActiveTab }: SidebarProps) {
  ...
  return (
    <aside className="w-64 flex-shrink-0 border-r bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 h-[calc(100vh-4rem)] sticky top-16 hidden md:block">
      ...
      <div className="absolute bottom-4 left-4 right-4">
        <div className="rounded-lg bg-secondary/50 p-4 border border-border/50 backdrop-blur-sm">
          <p className="text-xs font-semibold text-foreground">LetraScopio v1.0</p>
